...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, :produto => { :codigo_barras => @produto.codigo_barras, :nome => @produto.nome, :preco_nominal => @produto.preco_nominal, :preco_promocional => @produto.preco_promocional }
    end
  ...
  test "should update produto" do
    put :update, :id => @produto, :produto => { :codigo_barras => @produto.codigo_barras, :nome => @produto.nome, :preco_nominal => @produto.preco_nominal, :preco_promocional => @produto.preco_promocional }
    assert_redirected_to produto_path(assigns(:produto))
  end
